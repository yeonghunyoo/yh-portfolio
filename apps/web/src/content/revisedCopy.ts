...
export const Revised = {
  ...
  /**
   * 소개 문단의 둘째 문장 뒷부분. 원문은 "…하고, 그 도구로 다시 서비스를 만드는
   * 방식으로 일합니다" 였다. "다시" 가 가리킬 앞말이 없었고, 바로 다음 문단의
   * "그 도구로 Forest 라는 서비스를 만들고 있습니다" 와 같은 말을 먼저 해 버려
   * 구체 사례의 힘을 빼앗았다. 도구를 만든다는 사실만 말하고 왜 만드는지가
   * 빠져 있기도 했다 — 목적은 반복을 덜어 서비스에 집중하는 것이다.
   */
  toolPurpose: entry(
    "합니다. 반복은 도구에 맡기고, 서비스를 좋게 만드는 데 집중합니다.",
    "Strings.Resume.hagoGeuDoguroDasiSeobiseureulMandeuneun",
    "'다시' 가 가리킬 앞말이 없었고 다음 문단과 같은 말을 되풀이했다. 도구를 만드는 목적(반복을 덜어 서비스에 집중)을 밝힌다.",
  ),
} as const;
